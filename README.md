...
All paths here are relative to: `C:\Program Files\WindowsApps\Microsoft.WinDbg_1.2210.3001.0_x64__8wekyb3d8bbwe\amd64\ttd` or where ever you have WinDbgX plus "amd64\ttd".
...
Plus some of my colleagues raved about how TTD (using [WinDbgX aka "WinDbg Preview"](https://apps.microsoft.com/store/detail/windbg-preview/9PGJGD53TN86)) greatly improved debugging Windows applications so I wanted to play with feature for a while. 
